package com.example.marvelappstart.di

import com.example.marvelappstart.data.remote.ServiceApi
import com.example.marvelappstart.util.Constantes
        ...
        return OkHttpClient().newBuilder()
            .addInterceptor { chain ->
                ...
                val newUrl = chain.request().url
                    .newBuilder()
                    .addQueryParameter(Constantes.TS, currentTimestamp.toString())
                    .addQueryParameter(Constantes.APIKEY, Constantes.PUBLIC_KEY)
                    .addQueryParameter(
                        Constantes.HASH,
                        provideToMd5Hash(currentTimestamp.toString() + Constantes.PRIVATE_KEY + Constantes.PUBLIC_KEY)
                    )
                    .build()
