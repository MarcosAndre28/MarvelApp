...
import com.example.marvelappstart.ui.adapters.CharacterAdapter
import com.example.marvelappstart.ui.base.BaseFragment
import com.example.marvelappstart.ui.state.ResourceState
import com.example.marvelappstart.util.hide
import com.example.marvelappstart.util.show
import com.example.marvelappstart.util.toast
        ...
        viewModel.list.collect { resources ->
            when (resources) {
                ...
                is ResourceState.Error -> {
                    binding.progressCircular.hide()
                    resources.message?.let { messager ->
                        toast(getString(R.string.an_error_occurred))
                        Timber.tag("ListCharacterFragment").e("Error -> $messager")
                    }
                }
